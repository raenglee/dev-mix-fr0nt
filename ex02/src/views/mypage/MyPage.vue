<template>
  <div class="w-4/6 mx-auto">
    ...
    <div class="flex flex-wrap m-auto justify-around gap-5">
      <RouterLink to="/mypage/myprofile" class="mypage-tab mb-10 px-4 py-2 mx-2 hover:font-bold" active-class="font-bold border-b-2 border-[#d10000]">프로필</RouterLink>
      ...
      <RouterLink to="/mypage/mylikeposts" class="mypage-tab mb-10 px-4 py-2 mx-2 hover:font-bold" active-class="font-bold border-b-2 border-[#d10000]">북마크</RouterLink>
