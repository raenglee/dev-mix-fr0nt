    ...
    <div class="justify-center items-center">
      <div class="my-3">
        ...
        <form @submit.prevent="handleSubmit" class="grid gap-y-6 px-20 py-10">
          ...
          <!-- 닉네임 -->
          <div class="grid grid-cols-5 items-center gap-x-4">
            <label for="nickname" class="col-start-2 text-gray-700 text-lg font-semibold">닉네임 <span class="text-red-500">*</span></label>
            <div class="col-span-2 flex items-center">
...
const handleNicknameCheck = async () => {
  ...
  try {
    ...
    nicknameError.value = error.message || '닉네임 중복 확인 실패. 다시 시도해주세요.';
  }
};
